          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Присоединяйтесь к нам сегодня и откройте новые горизонты знаний
              </h2>
              <p>
                Станьте частью международного сообщества молодых талантов!
                Участвуйте в интеллектуальных олимпиадах, раскрывайте свои
                способности и прокладывайте путь к успеху вместе с нами. Каждый
                шаг — это новый вызов, возможность и шаг к вершине вашего
                потенциала.
              </p>
            </motion.div>
            <motion.div
